/**
 * devlib.domTools.js
 * Extended Tools for UI elements, DOM Manipulation, 
 * Shadow DOM, virtual DOM, and DOM editing
 */
...
class DomTools {
     ...
     */
    keepObjectInBox(elem, container, padding) {
        var elemDims = {
            x: $(elem).offset().left,
            y: $(elem).offset().top,
            width: $(elem).width(),
    ...
    dialogBox(options) { return new DialogBox(options); } 
}
